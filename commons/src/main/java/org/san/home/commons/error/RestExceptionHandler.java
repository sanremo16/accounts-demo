...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ErrorDto createDtoException(@NotNull MethodArgumentNotValidException e) {
        ...
        StringBuilder exceptionText = new StringBuilder(
                CommonException.getLocalizedMessageFromResource(CommonErrorCode.VALIDATION_ERROR.getName()));
        ...
        return new ErrorDto(CommonErrorCode.VALIDATION_ERROR.getCode(), exceptionText.toString(), arguments, ExceptionUtils.getStackTrace(e));
    }
